 ...
 * (por ahora lo dejamos para no romper de golpe el build mientras migrás archivo por archivo)
 */
...
type EventPayloadMapping = {
  ...
  // ⚠️ legacy: se elimina cuando removamos el módulo variable-mapa
...
interface Window {
  electron: {
    ...
    /**
     * ✅ A: 1 mapa por capa -> params solo capaId (el grupo es parte del mapa)
     * (esto lo vas a alinear cuando migres el módulo maps)
     */
